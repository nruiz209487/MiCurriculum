...
class Navigation {
    ...
    updateNavbarStyle() {
        ...
        this.navbar.style.background = isScrolled ? 'rgba(255, 255, 255, 0.98)' : 'rgba(255, 255, 255, 0.95)';
...
class Animations {
    ...
    setupParallax() {
        ...
        const debouncedParallax = utils.debounce(() => {
            ...
            this.hero.style.transform = `translateY(${scrolled * config.parallaxRate}px)`;
        }, 5);
